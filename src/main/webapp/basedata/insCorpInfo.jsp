...
<body>
				 ...
				 <div class="rows" id='mysearch'>
					...
					<table align="center">
						...
						<tr>
							...
							<tr>
							<td colspan="8" align="center"><button id="searchFilter" class="btn btn-primary btn-xs">查询</button></td>
						</tr>
		...
		<form class="form-horizontal" id="validation-form" method="post"  action="${ctx }/topInsCorpInfo/insertTopInsCorpInfo.do">
		...
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-3" style="float:left">
					<select id="channelFlag" name="channelFlag" class="col-xs-12 col-sm-10"  multiple  data-placeholder="Click to Choose...">
						<option value="">&nbsp;</option>
						<option value="01">柜面</option>
						<option value="02">网上银行</option>
						<option value="03">手机银行</option>
