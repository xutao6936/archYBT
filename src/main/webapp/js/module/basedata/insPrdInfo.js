$(function() {
	...
	$("#searchFilter").unbind('click').click(function(){
		...
		var data2 = $.extend({'page':1,'rows':10},$('#searchForm').serializeArray());
		alert(data);
		alert(data2);
		 jQuery("#grid-table").jqGrid('setGridParam', {
			   ...
			   postData:$.extend({'page':1,'rows':10},$('#searchForm').serializeArray())
	}).trigger("reloadGrid");
	});
	enableDate();
});
			   ...
			   position:"last"  
				   ...
				   position:"last"  
					   ...
					   onClickButton: function(){
						...
						//$("#dialog-insPrdPeriodform").dialog("destroy").remove();
