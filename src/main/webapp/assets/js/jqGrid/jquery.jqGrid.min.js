...
(function(b) {
    ...
    b.extend(b.jgrid, {
        ...
        parseDate: function(d, f, c, e) {
            ...
            else if (null !== j) h = new Date(parseInt(j[1], 10)),
            j[3] && (d = 60 * Number(j[5]) + Number(j[6]), d *= "-" === j[4] ? 1 : -1, d -= h.getTimezoneOffset(), h.setTime(Number(Number(h) + 6E4 * d)));
            else {
                f = ("" + f).replace(/\\T/g, "T").replace(/\\t/, "t").split(e.parseRe);
                d = d.replace(/\\T/g, "T").replace(/\\t/, "t").split(e.parseRe);
                i = 0;
                for (k = d.length; i < k; i++)"M" === d[i] && (j = b.inArray(f[i], e.monthNames), -1 !== j && 12 > j && (f[i] = j + 1, g.m = f[i])),
        ...
        from: function(d) {
            ...
            function(d, c) {
                ...
                this._compare = function(a, b, e) {
                    ...
                    if (null !== a && null === b) return - 1;
                    if ("[object Date]" === d.call(a) && "[object Date]" === d.call(b)) return a < b ? -e: a > b ? e: 0; ! j && "number" !== typeof a && "number" !== typeof b && (a = "" + a, b = "" + b);
                    ...
                    populateVisible: function() {
                        ...
                        if (a) {
                            ...
                            if (f) {
                                ...
                                f *= h;
                                var z, F, y;
                                if (k < a && 0 >= i && (void 0 === e.lastpage || parseInt((k + g + f - 1) / f, 10) <= e.lastpage)) F = parseInt((a - k + f - 1) / f, 10),
                                0 <= k || 2 > F || !0 === e.scroll ? (z = Math.round((k + g) / f) + 1, i = -1) : i = 1;
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length) alert(b.jgrid.errors.model);
                        ...
                        J = function(c, d, e, g, f) {
                            ...
                            if (b.isXMLDoc(c)) {
                                ...
                                c = b.jgrid.getXmlData(c, i.root, true); (c = b.jgrid.getXmlData(c, i.row, true)) || (c = []);
                                var w = c.length,
                                L = 0,
                                B = [],
                        ...
                        ja = function() {
                            function c(a) {
                                var b = 0,
                                d, e, g, h, i;
                                if (a.groups != null) { (e = a.groups.length && a.groupOp.toString().toUpperCase() === "OR") && s.orBegin();
                                ...
                                if (a.rules != null) try { (g = a.rules.length && a.groupOp.toString().toUpperCase() === "OR") && s.orBegin();
                        ...
                        if (a.p.multiSort) {
                            ...
                            for (g = 0; g < ba.length; g++) C = b.trim(ba[g]).split(" "),
                            ba[g] = b.trim(C[0]),
                            pa[g] = C[1] ? b.trim(C[1]) : a.p.sortorder || "asc"
                        }
                        for (g = 0; g < this.p.colNames.length; g++) C = a.p.headertitles ? ' title="' + b.jgrid.stripHtml(a.p.colNames[g]) + '"': "",
                        ...
                        a.p.pager && ("string" === typeof a.p.pager ? "#" !== a.p.pager.substr(0, 1) && (a.p.pager = "#" + a.p.pager) : a.p.pager = "#" + b(a.p.pager).attr("id"), b(a.p.pager).css({
                            width: c.width + "px"
                        }).addClass("ui-state-default ui-jqgrid-pager ui-corner-bottom").appendTo(l), H && b(a.p.pager).hide(), ka(a.p.pager, "")); ! 1 === a.p.cellEdit && !0 === a.p.hoverrows && b(a).bind("mouseover",
                        function(a) {
                        ...
                        if (a.p.caption) {
                            var ta = a.p.datatype; ! 0 === a.p.hidegrid && (b(".ui-jqgrid-titlebar-close", c.cDiv).click(function(d) {
                                ...
                                a.p.gridstate === "visible" ? b(g, "#gbox_" + b.jgrid.jqID(a.p.id)).slideUp("fast",
                                function() {
                                    f--;
                                    if (f === 0) {
                                ...
                                }) : a.p.gridstate === "hidden" && b(g, "#gbox_" + b.jgrid.jqID(a.p.id)).slideDown("fast",
                                function() {
                                    f--;
                                    if (f === 0) {
    ...
    b.jgrid.extend({
        ...
        getDataIDs: function() {
            ...
            e = 0;
            this.each(function() {
                if ((c = this.rows.length) && 0 < c) for (; f < c;) b(this.rows[f]).hasClass("jqgrow") && (d[e] = this.rows[f].id, e++),
                f++
            });
            return d
        },
        setSelection: function(d, f, c) {
            return this.each(function() {
                ...
                if (void 0 !== d && (f = !1 === f ? !1 : !0, (a = this.rows.namedItem("" + d)) && a.className && !( - 1 < a.className.indexOf("ui-state-disabled")))) if (!0 === this.p.scrollrows && (j = this.rows.namedItem(d).rowIndex, 0 <= j && (e = b(this.grid.bDiv)[0].clientHeight, g = b(this.grid.bDiv)[0].scrollTop, h = b(this.rows[j]).position().top, j = this.rows[j].clientHeight, h + j >= e + g ? b(this.grid.bDiv)[0].scrollTop = h - (e + g) + j + g: h < e + g && h < g && (b(this.grid.bDiv)[0].scrollTop = h))), !0 === this.p.frozenColumns && (i = this.p.id + "_frozen"), this.p.multiselect) {
                    ...
                    "aria-selected": "true",
                    tabindex: "0"
                }), i && (b("#" + b.jgrid.jqID(this.p.selrow), "#" + b.jgrid.jqID(i)).removeClass("ui-state-highlight"), b("#" + b.jgrid.jqID(d), "#" + b.jgrid.jqID(i)).addClass("ui-state-highlight")), e = !0) : e = !1, this.p.selrow = a.id, f)) b(this).triggerHandler("jqGridSelectRow", [a.id, e, c]),
                this.p.onSelectRow && this.p.onSelectRow.call(this, a.id, e, c)
            })
        },
        resetSelection: function(d) {
            return this.each(function() {
                var f = this,
                c, e, a; ! 0 === f.p.frozenColumns && (a = f.p.id + "_frozen");
                if (void 0 !== d) {
                ...
                }), f.setHeadCheckBox(!1), f.p.selarrrow = []) : f.p.selrow && (b("#" + b.jgrid.jqID(f.p.id) + " tbody:first tr#" + b.jgrid.jqID(f.p.selrow)).removeClass("ui-state-highlight").attr("aria-selected", "false"), a && b("#" + b.jgrid.jqID(f.p.selrow), "#" + b.jgrid.jqID(a)).removeClass("ui-state-highlight"), f.p.selrow = null); ! 0 === f.p.cellEdit && 0 <= parseInt(f.p.iCol, 10) && 0 <= parseInt(f.p.iRow, 10) && (b("td:eq(" + f.p.iCol + ")", f.rows[f.p.iRow]).removeClass("edit-cell ui-state-highlight"), b(f.rows[f.p.iRow]).removeClass("selected-row ui-state-hover"));
                f.p.savedRow = []
            })
        },
        ...
        addRowData: function(d, f, c, e) {
            ...
            f && (b.isArray(f) ? (t = !0, c = "last", A = d) : (f = [f], t = !1), this.each(function() {
                ...
                X = "",
                J = {},
                S = b.isFunction(this.p.afterInsertRow) ? true: false; N < V;) {
                    M = f[N];
                    g = [];
                    if (t) {
                        try {
            ...
            return this.each(function() {
                if (this.grid) {
                    ...
                    if (!isNaN(d)) {
                        ...
                        c.p.toppager && b(c.p.toppager).css("width", d + "px"); ! 0 === c.p.toolbar[0] && (b(c.grid.uDiv).css("width", d + "px"), "both" === c.p.toolbar[1] && b(c.grid.ubDiv).css("width", d + "px"));
                        c.p.footerrow && b(c.grid.sDiv).css("width", d + "px"); ! 1 === f && !0 === c.p.forceFit && (c.p.forceFit = !1);
                        if (!0 === f) {
                            b.each(c.p.colModel,
                            function() {
                                if (this.hidden === false) {
                            ...
                            c.p.tblwidth = a;
                            l = d - j * h - o;
                            if (!isNaN(c.p.height) && (b(c.grid.bDiv)[0].clientHeight < b(c.grid.bDiv)[0].scrollHeight || 1 === c.rows.length)) i = !0,
                            l -= k;
                            var a = 0,
        ...
        setCell: function(d, f, c, e, a, j) {
            return this.each(function() {
                ...
                if (this.grid && (isNaN(f) ? b(this.p.colModel).each(function(a) {
                    ...
                    var k = b("td:eq(" + g + ")", h);
                    if ("" !== c || !0 === j) h = this.formatter(d, c, g, h, "edit"),
                    i = this.p.colModel[g].title ? {
                        title: b.jgrid.stripHtml(h)
                    }: {},
                    this.p.treeGrid && 0 < b(".tree-wrap", b(k)).length ? b("span", b(k)).html(h).attr(i) : b(k).html(h).attr(i),
                    "local" === this.p.datatype && (h = this.p.colModel[g], c = h.formatter && "string" === typeof h.formatter && "date" === h.formatter ? b.unformat.date.call(this, c, h) : c, i = this.p._index[b.jgrid.stripPref(this.p.idPrefix, d)], void 0 !== i && (this.p.data[i][h.name] = c));
        ...
        getInd: function(b, f) {
            var c = !1,
            e;
            this.each(function() { (e = this.rows.namedItem(b)) && (c = !0 === f ? e: e.rowIndex)
            });
            return c
        },
        bindKeys: function(d) {
    ...
    a.fn.fmatter.select = function(c, b) {
        ...
        if (d) {
            ...
            } else a.fmatter.isObject(d) && (h ? e = a.map(j,
            function(a) {
                return d[a]
            }) : e[0] = d[c] || "")
        }
    ...
    a.unformat.select = function(c, b, d, e) {
        ...
        if (e.value) {
            ...
            if (a.fmatter.isString(g)) {
                ...
                i = 0,
                k;
                for (k = 0; k < j.length; k++) if (f = j[k].split(b), 2 < f.length && (f[1] = a.map(f,
                function(a, b) {
                    if (b > 0) return a
                ...
                if (!this.ftoolbar) {
                    var f = function() {
                        ...
                        function() {
                            ...
                            if ((f = "custom" === this.stype && a.isFunction(this.searchoptions.custom_value) && 0 < i.length && "SPAN" === i[0].nodeName.toUpperCase() ? this.searchoptions.custom_value.call(c, i.children(".customelement:first"), "get") : i.val()) || "nu" === n || "nn" === n) e[l] = f,
                            j[l] = n,
                            d++;
                            else try {
                        ...
                        var o = "stop" === a(c).triggerHandler("jqGridToolbarBeforeSearch") ? !0 : !1; ! o && a.isFunction(b.beforeSearch) && (o = b.beforeSearch.call(c));
                    ...
                    g = function(e, d, j) {
                        ...
                        function() {
                            ...
                            if (b.autosearch === true) {
                                i = a(e).parent().next().children()[0]; (a(i).val() || d === "nu" || d === "nn") && f()
                            }
                        })
                    },
                    ...
                    function() {
                        ...
                        k = a("<table class='ui-search-table' cellspacing='0'><tr><td class='ui-search-oper'></td><td class='ui-search-input'></td></tr></table>"); ! 0 === this.hidden && a(n).css("display", "none");
                        ...
                        if (this.search) {
                            ...
                            case "select":
                                ...
                                a.jgrid.ajaxOptions, c.p.ajaxSelectOptions || {}));
                                    ...
                                    if (m) {
                                        ...
                                        if ("string" === typeof m) {
                                            g = m.split(o);
                                            for (q = 0; q < g.length; q++) m = g[q].split(r),
                                        ...
                                        a(i).append(k); ! 0 === b.autosearch && a(l).change(function() {
                                            f();
                                            return false
                                        })
                                    }
                            ...
                            case "text":
                                ...
                                a.jgrid.bindEv.call(c, a("input", i)[0], d); ! 0 === b.autosearch && (b.searchOnEnter ? a("input", i).keypress(function(a) {
                            ...
                            case "custom":
                                ...
                                try {
                                    if (a.isFunction(d.custom_element)) {
                                        ...
                                        if (u) u = a(u).addClass("customelement"),
                    ...
                    this.clearToolbar = function(e) {
                        ...
                        var m = a(c).triggerHandler("jqGridToolbarBeforeClear") === "stop" ? true: false; ! m && a.isFunction(b.beforeClear) && (m = b.beforeClear.call(c));
        ...
        destroyGroupHeader: function(b) {
            ...
            return this.each(function() {
                ...
                if (f) {
                    ...
                    a(d).prepend(c); ! 0 === b && a(this).jqGrid("setGridParam", {
                        groupHeader: null
                    })
                }
            })
                        ...
                        if (0 <= j && h) {
                            ...
                            if (b.p.groupHeader) {
                                ...
                                a("tr.jqg-second-row-header th", c).each(function() {
                                    ...
                                    if (l = parseInt(a(this).attr("rowspan"), 10)) e++,
                                    d++;
                                    p && (e += p, d++);
                                    if (e === j) return ! 1
                                });
                            ...
                            function(c, d, e) {
                                ...
                                a(d).attr("aria-selected", "true"); ! b.p.viewsortcols[0] && b.p.lastsort !== e && (a("span.s-ico", c).hide(), a("span.s-ico", d).show())
                            });
    ...
    a.extend(a.jgrid, {
        ...
        createModal: function(d, b, c, g, e, h, f) {
            ...
            a(m).append(b);
            i.appendChild(m);
            a(i).prepend(k); ! 0 === h ? a("body").append(i) : "string" === typeof h ? a(h).append(i) : a(i).insertBefore(g);
            a(i).css(f);
        ...
        checkDate: function(a, b) {
            ...
            f = -1,
            i;
            for (i = 0; i < a.length; i++) e = isNaN(b[i]) ? 0 : parseInt(b[i], 10),
            c[a[i]] = e,
            e = a[i],
            -1 !== e.indexOf("y") && (g = i),
            -1 !== e.indexOf("m") && (f = i),
    ...
    a.jgrid.extend({
        searchGrid: function(b) {
            ...
            return this.each(function() {
                ...
                if (e.grid) {
                    ...
                    "string" === typeof s && (s = a.jgrid.parse(s)); ! 0 === b.recreateFilter && a("#" + a.jgrid.jqID(u.themodal)).remove();
                    if (void 0 !== a("#" + a.jgrid.jqID(u.themodal))[0]) c(a("#fbox_" + a.jgrid.jqID( + e.p.id)));
                        ...
                        b.columns.length ? (n = b.columns, p = 0, o = n[0].index || n[0].name) : a.each(n,
                        function(a, b) {
                        ...
                        k = !1;
                        b.tmplNames && b.tmplNames.length && (k = !0, f = b.tmplLabel, f += "<select class='ui-template'>", f += "<option value='default'>Default</option>", a.each(b.tmplNames,
                        function(a, b) {
                        ...
                        b.layer ? a.jgrid.createModal(u, m, b, "#gview_" + a.jgrid.jqID(e.p.id), a("#gbox_" + a.jgrid.jqID(e.p.id))[0], "#" + a.jgrid.jqID(b.layer), {
                            position: "relative"
                        }) : a.jgrid.createModal(u, m, b, "#gview_" + a.jgrid.jqID(e.p.id), a("#gbox_" + a.jgrid.jqID(e.p.id))[0]); (b.searchOnEnter || b.closeOnEscape) && a("#" + a.jgrid.jqID(u.themodal)).keydown(function(c) {
                            var d = a(c.target);
            ...
            return this.each(function() {
                ...
                function i(c, e, l, g) {
                    ...
                    a(e.p.colModel).each(function(r) {
                        ...
                        if ("cb" !== h && "subgrid" !== h && !0 === this.editable && "rn" !== h) {
                            ...
                            o = a.jgrid.createEl.call(d, this.edittype, v, i, !1, a.extend({},
                        ...
                        o && (a('td[role="gridcell"]', o).each(function(j) {
                            ...
                            if ("cb" !== l && "subgrid" !== l && "rn" !== l && !0 === m[j].editable) {
                                ...
                                case "checkbox":
                                    ...
                                    0 > g.search(/(false|f|0|no|n|off|undefined)/i) && "" !== g ? (a("#" + l, "#" + f)[d.p.useProp ? "prop": "attr"]("checked", !0), a("#" + l, "#" + f)[d.p.useProp ? "prop": "attr"]("defaultChecked", !0)) : (a("#" + l, "#" + f)[d.p.useProp ? "prop": "attr"]("checked", !1), a("#" + l, "#" + f)[d.p.useProp ? "prop": "attr"]("defaultChecked", !1));
                                    break;
                                case "custom":
                                    try {
                ...
                function s() {
                    ...
                    if (l[0] && !b[d.p.id].processing) {
                        ...
                        a.jgrid.ajaxOptions, b[d.p.id].ajaxEditOptions); ! n.url && !b[d.p.id].useDataProxy && (a.isFunction(d.p.dataProxy) ? b[d.p.id].useDataProxy = !0 : (l[0] = !1, l[1] += " " + a.jgrid.errors.nourl));
                ...
                function h() {
                    ...
                    e(), K = m(j, b[d.p.id]._savedData))) a("#" + f).data("disabled", !0),
                ...
                if (d.grid && r) {
                    ...
                    v,
                    f = a.jgrid.jqID(f);
                    "new" === r ? (r = "_empty", v = "add", c.caption = b[d.p.id].addCaption) : (c.caption = b[d.p.id].editCaption, v = "edit"); ! 0 === c.recreateForm && void 0 !== a("#" + a.jgrid.jqID(p.themodal))[0] && a("#" + a.jgrid.jqID(p.themodal)).remove();
                    var G = !0;
                    ...
                    if (void 0 !== a("#" + a.jgrid.jqID(p.themodal))[0]) {
                        ...
                        t(r, d, f);
                        "_empty" === r || !b[d.p.id].viewPagerButtons ? a("#pData, #nData", k + "_2").hide() : a("#pData, #nData", k + "_2").show(); ! 0 === b[d.p.id].processing && (b[d.p.id].processing = !1, a("#sData", k + "_2").removeClass("ui-state-active")); ! 0 === a("#" + f).data("disabled") && (a(".confirm", "#" + a.jgrid.jqID(p.themodal)).hide(), a("#" + f).data("disabled", !1));
                        ...
                        var L = !1; ! 0 === c.closeOnEscape && (c.closeOnEscape = !1, L = !0);
                        ...
                        c.closeicon = a.extend([!0, "left", "ui-icon-close"], c.closeicon); ! 0 === c.saveicon[0] && a("#sData", k + "_2").addClass("right" === c.saveicon[1] ? "fm-button-icon-right": "fm-button-icon-left").append("<span class='ui-icon " + c.saveicon[2] + "'></span>"); ! 0 === c.closeicon[0] && a("#cData", k + "_2").addClass("right" === c.closeicon[1] ? "fm-button-icon-right": "fm-button-icon-left").append("<span class='ui-icon " + c.closeicon[2] + "'></span>");
                        if (b[d.p.id].checkOnSubmit || b[d.p.id].checkOnUpdate) H = "<a href='javascript:void(0)' id='sNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>" + c.bYes + "</a>",
        ...
        viewGridRow: function(r, c) {
            ...
            b[a(this)[0].p.id] = c;
            return this.each(function() {
                function e() { (!0 === b[m.p.id].closeOnEscape || !0 === b[m.p.id].navkeys[0]) && setTimeout(function() {
                ...
                if (m.grid && r) {
                    ...
                    o = !0,
                    k = 1,
                    p = 0; ! 0 === c.recreateForm && void 0 !== a("#" + a.jgrid.jqID(q.themodal))[0] && a("#" + a.jgrid.jqID(q.themodal)).remove();
                    if (void 0 !== a("#" + a.jgrid.jqID(q.themodal))[0]) {
                        ...
                        c.closeicon = a.extend([!0, "left", "ui-icon-close"], c.closeicon); ! 0 === c.closeicon[0] && a("#cData", "#" + n + "_2").addClass("right" === c.closeicon[1] ? "fm-button-icon-right": "fm-button-icon-left").append("<span class='ui-icon " + c.closeicon[2] + "'></span>");
            ...
            return this.each(function() {
                ...
                if (e.grid && r) {
                    ...
                    if (void 0 !== a("#" + a.jgrid.jqID(o.themodal))[0]) {
                        ...
                        a("#DelError", "#" + g).hide(); ! 0 === b[e.p.id].processing && (b[e.p.id].processing = !1, a("#dData", "#" + g).removeClass("ui-state-active"));
                        ...
                        c.cancelicon = a.extend([!0, "left", "ui-icon-cancel"], b[e.p.id].cancelicon); ! 0 === c.delicon[0] && a("#dData", "#" + g + "_2").addClass("right" === c.delicon[1] ? "fm-button-icon-right": "fm-button-icon-left").append("<span class='ui-icon " + c.delicon[2] + "'></span>"); ! 0 === c.cancelicon[0] && a("#eData", "#" + g + "_2").addClass("right" === c.cancelicon[1] ? "fm-button-icon-right": "fm-button-icon-left").append("<span class='ui-icon " + c.cancelicon[2] + "'></span>");
                ...
                if (!this.nav) {
                    ...
                    if (h.grid && "string" === typeof b) {
                        ...
                        for (x = 0; x < n; x++) {
                            ...
                            c.add && (i = i || {},
                            g = a("<td class='ui-pg-button ui-corner-all'></td>"), a(g).append("<div class='ui-pg-div'><span class='ui-icon " + c.addicon + "'></span>" + c.addtext + "</div>"), a("tr", f).append(g), a(g, f).attr({
                                title: c.addtitle || "",
                                id: i.id || "add_" + k
                            }).click(function() {
                            ...
                            c.edit && (g = a("<td class='ui-pg-button ui-corner-all'></td>"), e = e || {},
                            a(g).append("<div class='ui-pg-div'><span class='ui-icon " + c.editicon + "'></span>" + c.edittext + "</div>"), a("tr", f).append(g), a(g, f).attr({
                                title: c.edittitle || "",
                                id: e.id || "edit_" + k
                            }).click(function() {
                            ...
                            c.view && (g = a("<td class='ui-pg-button ui-corner-all'></td>"), s = s || {},
                            a(g).append("<div class='ui-pg-div'><span class='ui-icon " + c.viewicon + "'></span>" + c.viewtext + "</div>"), a("tr", f).append(g), a(g, f).attr({
                                title: c.viewtitle || "",
                                id: s.id || "view_" + k
                            }).click(function() {
                                if (!a(this).hasClass("ui-state-disabled")) {
                            ...
                            c.del && (g = a("<td class='ui-pg-button ui-corner-all'></td>"), t = t || {},
                            a(g).append("<div class='ui-pg-div'><span class='ui-icon " + c.delicon + "'></span>" + c.deltext + "</div>"), a("tr", f).append(g), a(g, f).attr({
                                title: c.deltitle || "",
                                id: t.id || "del_" + k
                            }).click(function() {
                                if (!a(this).hasClass("ui-state-disabled")) {
                                    ...
                                    if (b) a.isFunction(c.delfunc) ? c.delfunc.call(h, b) : a(h).jqGrid("delGridRow", b, t);
                                    else {
                                        a.jgrid.viewModal("#" + m.themodal, {
                                            gbox: "#gbox_" + a.jgrid.jqID(h.p.id),
                                            jqm: true
                                ...
                                return false
                            }).hover(d, q), g = null); (c.add || c.edit || c.del || c.view) && a("tr", f).append("<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>");
                            c.search && (g = a("<td class='ui-pg-button ui-corner-all'></td>"), u = u || {},
                            a(g).append("<div class='ui-pg-div'><span class='ui-icon " + c.searchicon + "'></span>" + c.searchtext + "</div>"), a("tr", f).append(g), a(g, f).attr({
                                title: c.searchtitle || "",
                                id: u.id || "search_" + k
                            }).click(function() {
                ...
                if (l) {
                    ...
                    this.createTableForGroup = function(g, j) {
                        ...
                        if (!0 === this.p.ruleButtons) {
                            ...
                            var h = "",
                            i;
                            for (c = 0; c < n.groupOps.length; c++) i = g.groupOp === b.p.groupOps[c].op ? " selected='selected'": "",
                        ...
                        null !== j && (h = a("<input type='button' value='-' title='Delete group' class='delete-group'/>"), e.append(h), h.bind("click",
                        function() {
                    ...
                    this.createTableRowForRule = function(g, j) {
                        ...
                        function() {
                            ...
                            if (i) {
                                ...
                                for (e = 0; e < h.length; e++) o = a.inArray(h[e], q),
                        ...
                        for (e = m = 0; e < b.p.columns.length; e++) {
                            ...
                            if (!0 === b.p.columns[e].searchoptions.searchhidden && p || p && !r) p = "",
                        ...
                        for (e = 0; e < h.length; e++) o = a.inArray(h[e], q),
                        -1 !== o && (p = g.op === b.p.ops[o].oper ? " selected='selected'": "", d += "<option value='" + b.p.ops[o].oper + "'" + p + ">" + b.p.ops[o].text + "</option>");
                        s.append(d);
                        ...
                        d = a("<td></td>");
                        k.append(d); ! 0 === this.p.ruleButtons && (m = a("<input type='button' value='-' title='Delete rule' class='delete-rule ui-del'/>"), d.append(m), m.bind("click",
                        function() {
    ...
    a.jgrid.extend({
        editRow: function(c, b, e, o, l, g, n, h, f) {
            ...
            return this.each(function() {
                ...
                l = {},
                g, k;
                if (d.grid && (g = a(d).jqGrid("getInd", c, !0), !1 !== g && "0" === (a(g).attr("editable") || "0") && !a(g).hasClass("not-editable-row"))) k = d.p.colModel,
                ...
                0 < e && (l.id = c, d.p.savedRow.push(l), a(g).attr("editable", "1"), a("td:eq(" + h + ") input", g).focus(), !0 === j.keys && a(g).bind("keydown",
                function(f) {
                    if (27 === f.keyCode) {
        ...
        saveRow: function(c, b, e, o, l, g, n) {
            ...
            if ("1" === h) {
                    ...
                    if ("cb" !== m && "subgrid" !== m && !0 === k.editable && "rn" !== m && !a(this).hasClass("not-editable-cell")) {
                        ...
                        case "select":
                            if (k.editoptions.multiple) {
                                ...
                                w[m] = g.join(",")
                            } else i[m] = a("select option:selected", this).val(),
                ...
                if (i) {
                    ...
                    else if (q.id !== d.p.idPrefix + i[p] && (h = a.jgrid.stripPref(d.p.idPrefix, c), void 0 !== d.p._index[h] && (d.p._index[i[p]] = d.p._index[h], delete d.p._index[h]), c = d.p.idPrefix + i[p], a(q).attr("id", c), d.p.selrow === u && (d.p.selrow = c), a.isArray(d.p.selarrrow) && (h = a.inArray(u, d.p.selarrrow), 0 <= h && (d.p.selarrrow[h] = c)), d.p.multiselect)) h = "jqg_" + d.p.id + "_" + c,
                    a("input.cbox", q).attr("id", h).attr("name", h);
                    void 0 === d.p.inlineData && (d.p.inlineData = {});
                    i = a.extend({},
                    i, d.p.inlineData, f.extraparam)
                }
                if ("clientArray" === f.url) {
                    i = a.extend({},
                    i, w);
                    d.p.autoencode && a.each(i,
                    function(d, c) {
                    ...
                    complete: function(b, g) {
                        ...
                        if ("success" === g) {
                            ...
                            if (!0 === e) {
                                ...
                                j = !0;
                                a(q).removeClass("jqgrid-new-row").unbind("keydown")
                            } else a(d).triggerHandler("jqGridInlineErrorSaveRow", [c, b, g, null, f]),
        ...
        addRow: function(c) {
            ...
            return this.each(function() {
                if (this.grid) {
                    var b = this;
                    c.rowID = a.isFunction(c.rowID) ? c.rowID.call(b, c) : null != c.rowID ? c.rowID: a.jgrid.randId(); ! 0 === c.useDefValues && a(b.p.colModel).each(function() {
        ...
        inlineNav: function(c, b) {
            ...
            return this.each(function() {
                if (this.grid) {
                    ...
                    }), a("#" + l + "_ilcancel").addClass("ui-state-disabled")); ! 0 === b.restoreAfterSelect && (o = a.isFunction(e.p.beforeSelectRow) ? e.p.beforeSelectRow: !1, e.p.beforeSelectRow = function(c, f) {
                        var g = true;
    ...
    c.fn.jqm = function(a) {
        ...
        return this.each(function() {
            if (this._jqm) return j[this._jqm].c = c.extend({},
            j[this._jqm].c, a);
            l++;
            this._jqm = l;
            j[l] = {
    ...
    c.jqm = {
        ...
        open: function(a, i) {
            ...
            e.ajax ? (f = e.target || b.w, g = e.ajax, f = "string" == typeof f ? c(f, b.w) : c(f), g = "@" == g.substr(0, 1) ? c(i).attr(g.substring(1)) : g, f.html(e.ajaxText).load(g,
            function() {
    ...
    d.jgrid.extend({
        groupingSetup: function() {
            return this.each(function() {
                ...
                if (null !== a && ("object" === typeof a || d.isFunction(a))) if (a.groupField.length) {
                    ...
                    a.groups = [];
                    a.counters = [];
                    for (b = 0; b < a.groupField.length; b++) a.groupOrder[b] || (a.groupOrder[b] = "asc"),
                    ...
                    !0 === a.groupColumnShow[b] ? (a.visibiltyOnNextGrouping[b] = !0, d(this).jqGrid("showCol", a.groupField[b])) : (a.visibiltyOnNextGrouping[b] = d("#" + d.jgrid.jqID(this.p.id + "_" + a.groupField[b])).is(":visible"), d(this).jqGrid("hideCol", a.groupField[b]));
                    a.summary = [];
                    b = 0;
        ...
        groupingPrepare: function(b, g, f, a) {
            this.each(function() {
                ...
                l, j, m, q = 0;
                for (c = 0; c < k; c++) l = e.groupField[c],
                m = e.displayField[c],
                j = f[l],
                m = null == m ? null: f[m],
                null == m && (m = j),
                void 0 !== j && (0 === a ? (e.groups.push({
                    ...
                    pos: e.groups.length - 1,
                    summary: d.extend(!0, [], e.summary)
                }) : (e.counters[c].cnt += 1, e.groups[e.counters[c].pos].cnt = e.counters[c].cnt), d.each(e.counters[c].summary,
                function() {
            ...
            this.each(function() {
                ...
                if (k.hasClass(e)) {
                    if (g.showSummaryOnHide) {
                        if (c) for (; c && !(d(c).hasClass("jqfoot") && parseInt(d(c).attr("jqfootlevel"), 10) <= a);) d(c).hide(),
                        c = c.nextSibling
                    } else if (c) for (; c;) {
                    ...
                    if (c) for (; c;) {
                        g = c.className.indexOf(f);
                        if ( - 1 !== g && parseInt(c.className.substring(g + f.length + 1), 10) <= a) break;
                        d(c).show(); (g = d(c).find("span.tree-wrap-" + this.p.direction)) && d(g).hasClass(h) && d(g).removeClass(h).addClass(e);
                        c = c.nextSibling
                    }
            ...
            return this.each(function() {
                ...
                function(s, i) {
                    ...
                    if (w - 1 === i.idx) {
                        ...
                        p,
                        n,
                        B = void 0 !== o ? e.groups[s + 1].startRow: b.length;
    ...
    d.jgrid.extend({
        setTreeNode: function(b, c) {
            return this.each(function() {
                ...
                i = a.p.treeReader.leaf_field,
                g = a.p.treeReader.level_field,
                f = a.p.treeReader.icon_field,
                l = a.p.treeReader.loaded,
                k, m, n, j; b < c;) j = d.jgrid.stripPref(a.p.idPrefix, a.rows[b].id),
                j = a.p.data[a.p._index[j]],
                "nested" === a.p.treeGridModel && !j[i] && (k = parseInt(j[a.p.treeReader.left_field], 10), m = parseInt(j[a.p.treeReader.right_field], 10), j[i] = m === k + 1 ? "true": "false", a.rows[b].cells[a.p._treeleafpos].innerHTML = j[i]),
                k = parseInt(j[g], 10),
                0 === a.p.tree_root_level ? (n = k + 1, m = k) : (n = k, m = k - 1),
                ...
                "true" === j[i] || !0 === j[i] ? (n += (void 0 !== j[f] && "" !== j[f] ? j[f] : a.p.treeIcons.leaf) + " tree-leaf treeclick", j[i] = !0, m = "leaf") : (j[i] = !1, m = ""),
        ...
        getRootNodes: function() {
            ...
            this.each(function() {
                ...
                case "adjacency":
                    ...
                    d(c.p.data).each(function() { (null === this[h] || "null" === ("" + this[h]).toLowerCase()) && b.push(this)
                    })
                }
            });
            return b
            ...
            this.each(function() {
                ...
                case "nested":
                    ...
                    d(this.p.data).each(function() {
                        if (parseInt(this[i], 10) === l - 1 && parseInt(this[h], 10) < g && parseInt(this[e], 10) > f) return c = this,
                        !1
                    });
                    break;
                case "adjacency":
                    ...
                    d(this.p.data).each(function() {
                        if (this[m] === d.jgrid.stripPref(a.p.idPrefix, b[k])) return c = this,
                        !1
                    })
                }
            });
        ...
        addChildNode: function(b, c, a, h) {
            ...
            if (a) {
                ...
                if (null === c || d(e).jqGrid("isNodeLoaded", q) || u) d(e).jqGrid("addRowData", b, a, j, s),
