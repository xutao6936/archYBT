...
public class TopInsCorpInfoController {
	...
	@ResponseBody
	public Map<String,Object> oper(@Valid TopInsCorpInfo topInsCorpInfo,BindingResult result,HttpServletRequest request){
	 ...
	 * @return
	 */
	public Map<String,Object> insert(@Valid TopInsCorpInfo topInsCorpInfo,BindingResult result,HttpServletRequest request) {
		if (result.hasErrors()) {
	...
	@ResponseBody
	public Map<String,Object> update(@Valid TopInsCorpInfo topInsCorpInfo,BindingResult result,HttpServletRequest request) {
