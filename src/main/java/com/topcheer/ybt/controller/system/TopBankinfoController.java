...
public class TopBankinfoController {
	private static Logger log = LoggerFactory
			.getLogger(TopBankinfoController.class);
	@Resource(name = "topBankinfoBizImpl")
	private ITopBankinfoBiz topBankinfoBiz;

	@RequestMapping("/getTopBankinfoList.do")
	@ResponseBody
	public PageInfo<TopBankinfo> getTopBankinfoList(String rows, String page,
			TopBankinfo topBankinfo) {
	...
	@ResponseBody
	public Map<String, Object> insert(@Valid TopBankinfo topBankinfo,
	...
	@ResponseBody
	public Map<String, Object> update(@Valid TopBankinfo topBankinfo,
			BindingResult result, HttpServletRequest request) {
		if (result.hasErrors()) {
			return ResultHelper.analyzeError(result);
		}
	...
	@ResponseBody
	public Map<String, Object> oper(@Valid TopBankinfo topBankinfo,
			BindingResult result, HttpServletRequest request) {
