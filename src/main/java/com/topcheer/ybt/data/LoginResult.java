...
public class LoginResult {
	...
	public LoginResult(String result, String userDept, String filePath,
			String userName, String sex, String deptName) {
		super();
		this.result = result;
	...
	public String toString() {
		return "LoginResult [result=" + result + ", userDept=" + userDept
